...
class LoginModel : UserLoginContract.ByPhoneIModel {
    ...
    //登陆
    override fun login(phoneNumber: String, passwordText: String,loginBack: LoginBack): LoginResult {
        ...
        sendNetRequest.sendGetRequest("$baseUrl$string?phone=$phoneNumber&password=$passwordText"
            ...
            override fun onResponded(resultBody: String) {
                ...
                loginBack.onFinished(loginResult)
            }
    ...
    interface LoginBack{
        fun onFinished(account: LoginResult)
    }
